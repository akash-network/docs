## provider-services query staking redelegations-from
...
Example:
$ <appd> query staking redelegations-from akashvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
provider-services query staking redelegations-from [validator-addr] [flags]
```
