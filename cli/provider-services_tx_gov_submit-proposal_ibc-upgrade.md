## provider-services tx gov submit-proposal ibc-upgrade
...
```
provider-services tx gov submit-proposal ibc-upgrade [name] [height] [path/to/upgraded_client_state.json] [flags]
```
