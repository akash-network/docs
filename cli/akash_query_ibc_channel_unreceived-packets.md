## akash query ibc channel unreceived-packets
...
```
akash query ibc channel unreceived-packets [port-id] [channel-id] [flags]
```

### Examples

```
akash query ibc channel unreceived-packets [port-id] [channel-id] --sequences=1,2,3
```
