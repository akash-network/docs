## provider-services query staking unbonding-delegations
...
Example:
$ <appd> query staking unbonding-delegations akash1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```
provider-services query staking unbonding-delegations [delegator-addr] [flags]
```
