...
```
  -a, --account-number uint                         The account number of the signing account (offline mode only)
      --auth-pem string                             
      --balance-check-period duration               period at which the account balance is checked (default 10m0s)
  ...
  -h, --help                                        help for run
      ...
      --minimum-balance uint                        minimum account balance at which withdrawal is started (default 100000000)
