## akash query ibc channel packet-commitments
...
```
akash query ibc channel packet-commitments [port-id] [channel-id] [flags]
```

### Examples

```
akash query ibc channel packet-commitments [port-id] [channel-id]
```
