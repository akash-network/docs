## provider-services tx gov submit-proposal update-client
...
```
provider-services tx gov submit-proposal update-client [subject-client-id] [substitute-client-id] [flags]
```
