## akash tx gov submit-proposal param-change
...
Example:
$ akash tx gov submit-proposal param-change <path/to/proposal.json> --from=<key_or_address>
...
```
akash tx gov submit-proposal param-change [proposal-file] [flags]
```
