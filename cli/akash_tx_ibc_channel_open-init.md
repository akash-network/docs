## akash tx ibc channel open-init

Creates and sends a ChannelOpenInit message

```
akash tx ibc channel open-init [port-id] [counterparty-port-id] [connection-hops] [flags]
```
