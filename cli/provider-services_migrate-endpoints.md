## provider-services migrate-endpoints

migrate endpoints between deployments on the same provider

```
provider-services migrate-endpoints [flags]
```
...
```
  ...
  -h, --help                     help for migrate-endpoints
