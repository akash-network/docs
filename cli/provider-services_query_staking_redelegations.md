## provider-services query staking redelegations
...
Example:
$ <appd> query staking redelegation akash1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p

```
provider-services query staking redelegations [delegator-addr] [flags]
```
