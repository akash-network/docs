## akash tx ibc connection open-ack
...
```
akash tx ibc connection open-ack [connection-id] [counterparty-connection-id] [path/to/client_state.json] [consensus-height] [proof-height]
