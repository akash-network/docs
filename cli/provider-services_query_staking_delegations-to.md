## provider-services query staking delegations-to
...
Example:
$ <appd> query staking delegations-to akashvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj

```
provider-services query staking delegations-to [validator-addr] [flags]
```
