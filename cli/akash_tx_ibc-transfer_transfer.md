## akash tx ibc-transfer transfer
...
```
akash tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount] [flags]
```

### Examples

```
akash tx ibc-transfer transfer [src-port] [src-channel] [receiver] [amount]
```
