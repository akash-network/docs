...
```shell
$ akash tx bank send bob akash12wlzqjelrt87r3u56ps4m8lk7wavx5m5jg9cax 10000000akash -y -o json
...
| amount              | string | Y        | Amount need to send Eg: 10akash |
...
```shell
$ akash tx send bob akash12wlzqjelrt87r3u56ps4m8lk7wavx5m5jg9cax 10000000akash -y -o json
