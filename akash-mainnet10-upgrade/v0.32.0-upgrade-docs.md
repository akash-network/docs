...
Create the folder for the upgrade (v0.30.0) - cloned in this [step](v0.32.0-upgrade-docs.md#common-steps-for-all-upgrade-options) - and copy the akash binary into the folder.
