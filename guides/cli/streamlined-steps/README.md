...
For a more through review of the Akash CLI, including direct use of variables, visit the [Verbose Steps](../../../other-resources/experimental/mainnet3-legacy-docs/detailed-steps/) guide.
