...
Download the [linux archive](https://github.com/ovrclk/akash/releases/download/v0.6.1/akash_0.6.1_linux_amd64.zip) from the [release page](https://github.com/ovrclk/akash/releases).
