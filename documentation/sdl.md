...
An example deployment configuration can be found [here](https://github.com/ovrclk/docs/tree/c03b7cdc6c14faf2e334273b8e18e6ac06d02a77/sdl/deployment.yaml).
...
This defines a profile named `westcoast` having required attributes `{region="us-west"}`, and with a max price for the `web` and `db` [compute profiles](sdl.md#profilescompute) of 8 and 15 tokens per block, respectively.
