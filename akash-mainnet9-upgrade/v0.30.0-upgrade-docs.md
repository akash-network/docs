...
* [Binary Links](https://www.mintscan.io/akash/block/15414427)
...
Either download the [Akash binary](https://github.com/akash-network/node/releases/tag/v0.30.0) or build from source - completed in this [step](v0.30.0-upgrade-docs.md#common-steps-for-all-upgrade-options) - and ensure the `akash` binary has been updated:
