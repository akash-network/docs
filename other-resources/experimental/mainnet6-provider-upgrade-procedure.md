...
* Install provider-services `v0.4.1` on your local machine
...
> The link to the binary files in case if you have other than x86\_64 (amd64) architecture [https://github.com/akash-network/provider/releases/tag/v0.4.1](https://github.com/akash-network/provider/releases/tag/v0.4.1)

To install `provider-services` `v0.4.1` follow this doc [https://docs.akash.network/other-resources/sandbox/detailed-steps/part-1.-install-akash](https://docs.akash.network/other-resources/sandbox/detailed-steps/part-1.-install-akash)
...
* provider and operator image is: `ghcr.io/akash-network/provider:0.4.1`
...
# kubectl -n akash-services get pods -o custom-columns='NAME:.metadata.name,IMAGE:.spec.containers[*].image'
NAME                                        IMAGE
akash-hostname-operator-86d4596d6c-pwbt8    ghcr.io/akash-network/provider:0.4.1
akash-inventory-operator-69464fbdff-dxkk5   ghcr.io/akash-network/provider:0.4.1
akash-ip-operator-6f6ddc47f8-498kj          ghcr.io/akash-network/provider:0.4.1
akash-node-1-0                              ghcr.io/akash-network/node:0.24.0
akash-provider-0                            ghcr.io/akash-network/provider:0.4.1
```
