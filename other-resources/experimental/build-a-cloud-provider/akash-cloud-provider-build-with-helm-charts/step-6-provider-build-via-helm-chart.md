...
> _**NOTE**_- this sub-section and attributes discussed in this section are only relevant to Akash Providers hosting GPU resources
...
#### GPU Attribute Key-Value Template
...
> Note the use of the GPU key-value pair included in this example.  Remove such attributes if GPUs are not hosted on your provider.  If GPUs are hosted, ensure the correct model is specified.
