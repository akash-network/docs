...
The steps to create an Akash wallet are covered in the Provider setup section of this [document](../../../guides/cli/detailed-steps/part-2.-create-an-account.md) (_**Parts 1 and 2 only**_).
