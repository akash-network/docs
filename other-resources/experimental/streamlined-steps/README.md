...
For a more through review of the Akash CLI, including direct use of variables, visit the [Verbose Steps](../../archived-resources/mainnet3-legacy-docs/detailed-steps/) guide.
