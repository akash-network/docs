...
akash/akash-hostname-operator 	6.0.3        	0.4.4      	An operator to map Ingress objects to Akash dep...
akash/akash-inventory-operator	6.0.3        	0.4.4      	An operator required for persistent storage (op...
akash/akash-ip-operator       	6.0.3        	0.4.4      	An operator required for ip marketplace (optional)
akash/akash-node              	6.0.0        	0.24.0     	Installs an Akash RPC node (required)             
akash/provider                	6.0.3        	0.4.4      	Installs an Akash provider (required)      
```
