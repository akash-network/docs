...
<br />
<p align="center">
  <a href="https://github.com/ovrclk/docs">
    <img src="https://avatars.githubusercontent.com/u/4899835?s=200&v=4" alt="Logo" width="80" height="80">
  </a>

  <h3 align="center">Akash (AKT)</h3>

  <p align="center">
    Akash (AKT) is the World's first decentralized cloud
    <br />
    <a href="https://akash.network/"><strong>Explore more about Akash »</strong></a>
    <br />
    <br />
    <a href="https://forum.akash.network/">Forum</a>
    ·
    <a href="https://docs.akash.network/">Docs</a>
  </p>
</p>
...
<details open="open">
  ...
  <ol>
    <li>
      <a href="#about-akash">About Akash</a>
      <ul>
...
![Akash](https://avatars.githubusercontent.com/u/4899835?s=200&v=4) 
...
The [Akash Marketplace](decentralized-cloud/marketplace.md) is where users lease computing resources from Cloud providers before deploying a Docker container on the Akash Container Platform. 
The marketplace stores on-chain records of requests, bids, leases, and settlement payments using the Akash Token \(AKT\). Akash's blockchain is a [tendermint](https://github.com/tendermint/tendermint)-based application based on the [Cosmos SDK](https://github.com/cosmos/cosmos-sdk).

### Akash Container Platform
...
### Why is Akash cheaper than Tech Giants?
...
See the [open issues](https://github.com/ovrclk/docs/issues) for a list of proposed features (and known issues).
...
Discord - [Akash](https://discord.akash.network/)

Twitter: [Akash](https://twitter.com/akashnet_?s=20)

Telegram: [Akash](https://t.me/AkashNW)

Forum: [Akash](https://forum.akash.network/)
